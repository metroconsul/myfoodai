...
export const COMPARISON_ROWS: ComparisonRow[] = [
  ...
  { feature: "Usuários administrativos", values: ["Ilimitado", "Até 3", "Até 5"] },
  { feature: "Portal do Colaborador", values: ["Até 5 colaboradores", "Até 10 colaboradores", "Até 25 colaboradores"] },
