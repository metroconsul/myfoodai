...
export const PLANS: Plan[] = [
  {
    ...
    limits: [
      ...
      { label: "Usuários administrativos", value: "1" },
      { label: "Portal do Colaborador", value: "Até 5 pessoas" },
    ],
    features: [
      "Cadastro de pessoas",
      "Permissões básicas",
      "Cadastro de uma unidade",
      "Escalas e turnos básicos",
      "Modelos semanais de escala",
      "Registro de ponto pelo navegador ou celular",
      "Geolocalização básica para o registro de ponto",
      "Revisão manual dos registros de ponto",
      "Cadastro de itens e produtos",
      "Controle básico de estoque",
      "Estoque mínimo",
      "Registro de entrada, saída e perda",
      "Registro básico de vendas",
      "Dashboard operacional básico",
      "Relatórios básicos de escala, ponto, estoque e vendas",
  ...
  },
  {
    ...
    features: [
      ...
      "Mais de um usuário administrativo",
      "Escalas com múltiplos blocos por dia",
      "Turnos que atravessam a meia-noite",
      "Solicitação e revisão de ajustes de ponto",
      "Banco de horas básico",
      "Histórico de alterações",
      "Gestão de validade de itens",
      "Alertas de estoque mínimo",
      "Categorias e fornecedores",
      "Inventário básico",
      "Relatórios operacionais avançados",
      "Filtros por período, unidade e colaborador",
  ...
  },
  {
    ...
    features: [
      ...
      "Gestão de até 2 unidades",
      "Visão consolidada da operação",
      "Transferência de colaboradores entre unidades, conforme permissões",
      "Relatórios comparativos por unidade",
      "Dashboard operacional avançado",
      "Auditoria de ações dos usuários",
      "Histórico completo de alterações",
      "Escalas por unidade e função",
      "Gestão de disponibilidade e indisponibilidade",
      "Banco de horas e acompanhamento de saldo",
      "Estoque por unidade",
      "Transferências de estoque entre unidades",
      "Relatórios de perdas e movimentações",
      "Indicadores de vendas por período e unidade",
      "Mais filtros e exportações",
      "Controle avançado de permissões",
      "Portal do Colaborador com avisos, escala e acompanhamento de ponto",
      "Onboarding guiado",
