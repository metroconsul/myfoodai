...
import { Route as ApiPublicPbkdf2CheckRouteImport } from './routes/api/public/pbkdf2-check'
...
const ApiPublicPbkdf2CheckRoute = ApiPublicPbkdf2CheckRouteImport.update({
  id: '/api/public/pbkdf2-check',
  path: '/api/public/pbkdf2-check',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/api/public/pbkdf2-check': typeof ApiPublicPbkdf2CheckRoute
...
export interface RootRouteChildren {
  ...
  ApiPublicPbkdf2CheckRoute: typeof ApiPublicPbkdf2CheckRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/api/public/pbkdf2-check': {
      id: '/api/public/pbkdf2-check'
      path: '/api/public/pbkdf2-check'
      fullPath: '/api/public/pbkdf2-check'
      preLoaderRoute: typeof ApiPublicPbkdf2CheckRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/api/public/sales-ingest': {
      id: '/api/public/sales-ingest'
...
const rootRouteChildren: RootRouteChildren = {
  ...
  ApiPublicPbkdf2CheckRoute: ApiPublicPbkdf2CheckRoute,
